...
const resources = {
  en: {
    translation: {
      ...
      reportSubtitle: 'Detailed breakdown by category with filters',
      ...
      statementSubtitle: 'Bank statement-style report with running balance',
      ...
      // Profile Page
      Profile: 'Profile',
      profileSubtitle: 'Manage your account settings and avatar',
      Name: 'Name',
  ...
  bn: {
    translation: {
      ...
      // Report Page
      reportTitle: 'রিপোর্ট',
      reportSubtitle: 'ফিল্টার সহ ক্যাটাগরি ভিত্তিক বিস্তারিত রিপোর্ট',
      ...
      // Transaction Statement Page
      TransactionStatement: 'লেনদেন বিবরণী',
      statementSubtitle: 'চলমান ব্যালেন্স সহ ব্যাংক স্টেটমেন্ট-স্টাইল রিপোর্ট',
      Transactions: 'লেনদেন',
      Date: 'তারিখ',
      Type: 'টাইপ',
      Note: 'নোট',
      ...
      // Profile Page
      Profile: 'প্রোফাইল',
      profileSubtitle: 'আপনার অ্যাকাউন্ট সেটিংস এবং অ্যাভাটার পরিচালনা করুন',
      Name: 'নাম',
      Avatar: 'আপনার অ্যাভাটার নির্বাচন করুন',
